...
INSERT INTO HeThongKhoa 
    (tenHeThong, dangHoatDong, thongBaoTTHD, matKhauMaHoa, lanThayDoiMKCuoi, thongBaoTuXa, emailNhanTB, heThongID, maCua) 
VALUES
    ('Hệ thống cửa chính', TRUE, TRUE, '$2a$08$gEp8x1Ae3x3rCkHBfueEyeeMh/cUJKtJW.fFZHy/4bIOWzrR5Pjmm', DATE_ADD('2024-01-01 08:00:00', INTERVAL FLOOR(RAND() * 1000) DAY_SECOND), 1, 'xyz@gmail.com', 1, 1),
    ('Hệ thống cửa phụ', FALSE, FALSE, LPAD(FLOOR(RAND() * 10000), 4, '0'), DATE_ADD('2024-01-01 08:00:00', INTERVAL FLOOR(RAND() * 1000) DAY_SECOND), 0, 'xyz@gmail.com', 2, 2),
    ('Hệ thống cửa sân vườn', FALSE, FALSE, LPAD(FLOOR(RAND() * 10000), 4, '0'), DATE_ADD('2024-01-01 08:00:00', INTERVAL FLOOR(RAND() * 1000) DAY_SECOND), 0, 'xyz@gmail.com', 3, 3),
    ('Hệ thống cửa kho', FALSE, FALSE, LPAD(FLOOR(RAND() * 10000), 4, '0'), DATE_ADD('2024-01-01 08:00:00', INTERVAL FLOOR(RAND() * 1000) DAY_SECOND), 0, 'xyz@gmail.com', 4, 4),
    ('Hệ thống cửa gara', FALSE, FALSE, LPAD(FLOOR(RAND() * 10000), 4, '0'), DATE_ADD('2024-01-01 08:00:00', INTERVAL FLOOR(RAND() * 1000) DAY_SECOND), 0, 'xyz@gmail.com', 5, 5);
